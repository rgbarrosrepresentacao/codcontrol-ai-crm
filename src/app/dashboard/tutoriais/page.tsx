...
// Materiais de apoio placeholder (Simulando o que viria do Admin)
const supportMaterials = [
    { title: 'Manual de Configuração IA', type: 'PDF', link: '#' },
    { title: 'Script de Vendas Campeão', type: 'LINK', link: '#' },
    { title: 'Planilha de Planejamento de Funis', type: 'PDF', link: '#' },
]
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center">
                                            {material.type === 'PDF' ? <FileText className="w-5 h-5 text-primary" /> : <ExternalLink className="w-5 h-5 text-primary" />}
                                        </div>
                                        <div>
                                            <div className="text-sm font-semibold text-foreground">{material.title}</div>
                                            <div className="text-[10px] text-muted-foreground uppercase">{material.type}</div>
                                        </div>
                                    </div>
                                    <a 
                                        href={material.link} 
                            ...
                            {/* Card para Admin */}
                            <div className="flex items-center justify-center p-4 border border-dashed border-border rounded-xl opacity-50">
                                <span className="text-xs text-muted-foreground italic">Novos materiais via Painel Admin em breve...</span>
                            </div>
                        </div>
                    </div>
                </div>
