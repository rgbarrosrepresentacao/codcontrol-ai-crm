...
export default function MetaApiClientPage() {
    ...
    return (
        <div className="p-6 max-w-4xl mx-auto space-y-6">
            ...
            <div className="flex items-start justify-between">
                ...
                <span className="text-[10px] bg-emerald-500/20 text-emerald-400 px-2 py-1 rounded-lg border border-emerald-500/30 font-black">
                    PLANO PRO / AGÊNCIA
                </span>
            </div>
