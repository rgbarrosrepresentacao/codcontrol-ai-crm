        ...
        <div className="flex flex-col h-full">
            ...
            <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
                ...
                {isAdmin && (
                    <>
                        ...
                        {/* Bloco Premium de Disparo Inteligente movido para cá */}
                        <Link
                            href="/dashboard/blast"
                            onClick={() => setMobileOpen(false)}
                            className={cn(
                                'sidebar-link flex items-center gap-3 px-3 py-2.5 text-sm font-bold transition-all mt-2 bg-primary/5 border border-primary/10 rounded-xl',
            ...
            <div className="p-4 border-t border-sidebar-border">
                ...
                <div className="mt-4 px-3 flex items-center justify-between text-[10px] text-muted-foreground font-mono">
                    <span>Versão</span>
                    <span className="text-primary/70">v1.5.0</span>
                </div>
            </div>
        </div>
    )
